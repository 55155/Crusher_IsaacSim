...
class Link:
    ...
    def make_link_xml(self):
        ...
        mesh_v.attrib = {'filename':'package://' + self.repo + self.name + '.dae','scale':'0.001 0.001 0.001'}
        ...
        mesh_c.attrib = {'filename':'package://' + self.repo + self.name + '.dae','scale':'0.001 0.001 0.001'}
